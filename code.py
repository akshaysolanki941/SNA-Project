...
g = nx.read_edgelist("dataset1.txt", create_using=nx.Graph(), nodetype=int)

directed_g = nx.read_edgelist(
    "dataset1.txt", create_using=nx.DiGraph(), nodetype=int)
...
GCC = (3 * triangles) / ((3 * triangles) + (2 * open_traids))
print(GCC)
